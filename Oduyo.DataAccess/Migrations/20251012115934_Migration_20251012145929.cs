...
{
    /// <inheritdoc />
    public partial class Migration_20251012145929 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealerUserMappings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    MaxDiscountRate = table.Column<decimal>(type: "numeric", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<int>(type: "integer", nullable: false),
                    UpdatedBy = table.Column<int>(type: "integer", nullable: true),
                    DeletedBy = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountAuthorities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinRate = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    MaxRate = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferRevisions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReferenceCodeSequences", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VirtualPOSs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignModules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CampaignModules_Campaigns_CampaignId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CampaignPackages_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductInterests = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CreatedBy = table.Column<int>(type: "integer", nullable: false),
                    UpdatedBy = table.Column<int>(type: "integer", nullable: true),
                    DeletedBy = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_AspNetUsers_SupportUserId",
                        column: x => x.SupportUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Companies_Channels_ChannelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditUsages_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CreditUsages_Credits_CreditId",
                        column: x => x.CreditId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CompanyId = table.Column<int>(type: "integer", nullable: false),
                    DemoDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DemoEndTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Location = table.Column<string>(type: "text", nullable: true),
                    ProductInterests = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Demos_AspNetUsers_AssignedUserId",
                        column: x => x.AssignedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Demos_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Demos_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CampaignDiscount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ManualDiscount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ManualDiscountRate = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CampaignId = table.Column<int>(type: "integer", nullable: true),
                    IsCampaignLocked = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VirtualPOSId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_VirtualPOSs_VirtualPOSId",
                        column: x => x.VirtualPOSId,
                        principalTable: "VirtualPOSs",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "DealerCommissions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealerCommissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealerCommissions_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DealerCommissions_Dealers_DealerId",
                        column: x => x.DealerId,
                        principalTable: "Dealers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DealerCommissions_Offers_OfferId",
                        column: x => x.OfferId,
                        principalTable: "Offers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DealerCommissions_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignModules_CampaignId",
                table: "CampaignModules",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignPackages_CampaignId",
                table: "CampaignPackages",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_Companies_ChannelId",
                table: "Companies",
                column: "ChannelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_SupportUserId",
                table: "Companies",
                column: "SupportUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CreditUsages_CompanyId_UsedAt",
                table: "CreditUsages",
                columns: new[] { "CompanyId", "UsedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CreditUsages_CreditId",
                table: "CreditUsages",
                column: "CreditId");

            migrationBuilder.CreateIndex(
                name: "IX_DealerCommissions_CompanyId",
                table: "DealerCommissions",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_DealerCommissions_DealerId_Status",
                table: "DealerCommissions",
                columns: new[] { "DealerId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_DealerCommissions_OfferId",
                table: "DealerCommissions",
                column: "OfferId");

            migrationBuilder.CreateIndex(
                name: "IX_DealerCommissions_PaymentId",
                table: "DealerCommissions",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_Demos_AssignedUserId",
                table: "Demos",
                column: "AssignedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Demos_ChannelId",
                table: "Demos",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_Demos_CompanyId",
                table: "Demos",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Demos_ReferenceCode",
                table: "Demos",
                column: "ReferenceCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DiscountAuthorities_UserId",
                table: "DiscountAuthorities",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserHierarchies_ParentUserId_ChildUserId",
